...
const loadReplies = async (comment) => {
  ...
  try {
    ...
    const response = await fetchWithToken(`https://muqingxi.com:2345/proxy/articleReply?parentId=${commentId}`)
...
const loadComments = async () => {
  ...
  try {
    const response = await fetchWithToken(`https://muqingxi.com:2345/proxy/article?articleId=${props.articleId}`)
...
const submitComment = async () => {
  ...
  try {
    ...
    const response = await fetchWithToken('https://muqingxi.com:2345/proxy/addComment', {
      method: 'POST',
...
const submitReply = async (parentComment) => {
  ...
  try {
    ...
    const response = await fetchWithToken(
      'https://muqingxi.com:2345/proxy/addReply',
      {
        method: 'POST',
        headers: {
...
const deleteComment = async (timestamp) => {
  try {
    ...
    const response = await fetchWithToken(`https://muqingxi.com:2345/proxy/deleteComment?timestamp=${timestamp}`, {
      method: 'GET'
    })
